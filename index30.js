...
//
//   // if (this.attributes['flag']==2) {imageUrl = "https://bellard.org/bpg/3.png"};
//   // if (this.attributes['flag']==3) {imageUrl = "https://cdn.tutsplus.com/webdesign/uploads/legacy/038_ImageTypes/PNG24-example.png"};
//
//   var arr = [ { date: '23.08.2017', amount: randomInteger(-10000, 10000) },
//     { date: '24.08.2017', amount: randomInteger(-10000, 10000) },
//     { date: '25.08.2017', amount: randomInteger(-10000, 10000) },
//     { date: '26.08.2017', amount: randomInteger(-10000, 10000) } ];
//
//   axios2.post('https://google-chart.herokuapp.com/rr', arr).then(function(res) {
...
// }else{
//   self.emit(":ask", "tell first", "tell word connect first");
// }
// })
//   .catch((res) => {
//     self.emit(':tell', "error 123"+res);
//
//   });
